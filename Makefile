CID_FILE = /tmp/videoamp-redis-cluster.cid
CID =`cat $(CID_FILE)`
IMAGE_NAME = videoamp/redis-cluster
PORTS = -p 7001:7001 -p 7002:7002 -p 7003:7003
...
cli:
	docker exec -it $(CID) /redis/src/redis-cli -p 7001 
